...
pub mod delegated_identity_server {
    ...
    #[async_trait]
    pub trait DelegatedIdentity: std::marker::Send + std::marker::Sync + 'static {
    ...
    impl<T> DelegatedIdentityServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    pub const SERVICE_NAME: &str = "spire.api.agent.delegatedidentity.v1.DelegatedIdentity";
    impl<T> tonic::server::NamedService for DelegatedIdentityServer<T> {
